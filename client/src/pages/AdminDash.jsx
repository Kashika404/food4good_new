...
//     // Fetches the list of users awaiting verification
...
//             alert("You may not have admin access, or a server error occurred.");
//         }
//     };

//     // Load the users when the component first mounts
//     useEffect(() => {
//         fetchPendingUsers();
//     }, [token]);
...
//                     fetchPendingUsers(); // Refresh the list to remove the approved user
//                 }
//             } catch (error) {
...
//     // --- NEW: Function to handle rejecting a user ---
...
//                 if (response.data.success) {
//                     alert(response.data.message);
//                     fetchPendingUsers(); // Refresh the list to remove the rejected user
//                 }
//             } catch (error) {
...
//                             )) : (
//                                 <tr>
//                                     <td colSpan="5" className="text-center py-8 text-gray-500">No users are currently pending approval.</td>
//                                 </tr>
//                             )}
//                         </tbody>
//                     </table>
...
//     // Your existing handler functions are preserved
//     const handleApproveUser = async (userId) => {
//         if (window.confirm("Are you sure you want to approve this user?")) {
//             try {
//                 const response = await axios.post(`${url}/api/admin/approve/${userId}`, {}, { headers: { token } });
...
//                                     <td className="px-6 py-4">{user.email}</td>
//                                     <td className="px-6 py-4">{user.primaryRole}</td>
//                                     {/* --- NEW: Added a table cell with a link to the ID document --- */}
...
//                             )) : (
//                                 <tr>
//                                     {/* --- MODIFIED: Updated colSpan to account for the new column --- */}
