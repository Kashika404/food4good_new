...
const AvailableDonationCard = ({ donation, onClaim }) => {
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-lg flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mt-2 text-md text-neutral-700 flex-grow">
            <span className="font-medium">Quantity:</span> {donation.type === 'Cooked' ? `${donation.quantity.value} ${donation.quantity.unit}` : donation.quantity}
        </div>
      ...
      <div className="px-5 pb-5 mt-auto">
          <button 
            ...
            className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-2 rounded-lg transition-colors shadow-md hover:shadow-lg">
              Claim Donation
          </button>
      </div>
    </div>
